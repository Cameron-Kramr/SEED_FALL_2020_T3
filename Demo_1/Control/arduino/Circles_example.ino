...
#define kp_A (4.12835629707733)//Wheel 2 velocity por. gain
#define kd_A (0.00233603519251884)//Wheel 2 velocity dif. gain
#define ki_A (61.7452860007725)//Wheel 2 velocity int. gain

#define kp_B (4.12835629707733)//Wheel 2 velocity por. gain
...
while(millis()> Time_1 + Interval_time)
{
   ...
   setpoint_B=((Radius+d)*omega); // Get current linear velocity for motor 2 {Rad/s}
   setpoint_A=((Radius-d)*omega); // Get current linear velocity for motor 1 {Rad/s}
